<template>
  <div class="tc content has-text-white p-6">
    <h1>Terms and Conditions</h1>

    <p>Welcome to Floaty!</p>

    <p>
      These terms and conditions outline the rules and regulations for the use
      of Floaty's Website, located at https://www.floaty.me.
    </p>

    <p>
      By accessing this website we assume you accept these terms and conditions.
      Do not continue to use Floaty if you do not agree to take all of the terms
    ...
    <p>
      We employ the use of cookies. By accessing Floaty, you agreed to use
      cookies in agreement with the Floaty's Privacy Policy.
    </p>
    ...
    <p>
      Unless otherwise stated, Floaty and/or its licensors own the intellectual
      property rights for all material on Floaty. All intellectual property
      rights are reserved. You may access this from Floaty for your own personal
      use subjected to restrictions set in these terms and conditions.
    </p>

    <p>You must not:</p>
    <ul>
      <li>Republish material from Floaty</li>
      <li>Sell, rent or sub-license material from Floaty</li>
      <li>Reproduce, duplicate or copy material from Floaty</li>
      <li>Redistribute content from Floaty</li>
    </ul>
    ...
    <p>
      ...
      opinions and information in certain areas of the website. Floaty does not
      filter, edit, publish or review Comments prior to their presence on the
      website. Comments do not reflect the views and opinions of Floaty,its
      ...
      applicable laws, Floaty shall not be liable for the Comments or for any
    ...
    <p>
      Floaty reserves the right to monitor all Comments and to remove any
    ...
    <p>
      You hereby grant Floaty a non-exclusive license to use, reproduce, edit
    ...
    <p>
      ...
      hyperlink compensates the absence of Floaty; and (d) the link is in the
    ...
    <p>
      ...
      e-mail to Floaty. Please include your name, your organization name,
    ...
    <p>
      No use of Floaty's logo or other artwork will be allowed for linking
