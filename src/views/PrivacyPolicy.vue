<template>
  <div class="prpc content has-text-white p-6">
    <h1>Privacy Policy for Floaty</h1>

    <p>
      At Floaty, accessible from https://www.floaty.me, one of our main
      priorities is the privacy of our visitors. This Privacy Policy document
      contains types of information that is collected and recorded by Floaty and
      how we use it.
    </p>
    ...
    <p>
      ...
      <a href="mailto:durvankd83@gmail.com">durvankd83@gmail.com</a>.
    </p>

    <p>
      This Privacy Policy applies only to our online activities and is valid for
      visitors to our website with regards to the information that they shared
      and/or collect in Floaty. This policy is not applicable to any information
    ...
    <p>
      Floaty follows a standard procedure of using log files. These files log
    ...
    <p>
      Like any other website, Floaty uses 'cookies'. These cookies are used to
    ...
    <P
      ...
      advertising partners of Floaty.</P
    >

    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on Floaty, which are sent directly to
    ...
    <p>
      Note that Floaty has no access to or control over these cookies that are
    ...
    <p>
      Floaty's Privacy Policy does not apply to other advertisers or websites.
    ...
    <p>
      Floaty does not knowingly collect any Personal Identifiable Information
